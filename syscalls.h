...
#define         SP_TIME_MODE                  (INT16)0
#define         SP_ACTION_MODE                (INT16)1
#define         SP_TARGET_MODE                (INT16)2
#define         SP_STATE_MODE_START           (INT16)3
#define         SP_NEW_MODE                   (INT16)3
#define         SP_RUNNING_MODE               (INT16)4
#define         SP_READY_MODE                 (INT16)5
#define         SP_PROCESS_SUSPENDED_MODE     (INT16)6
#define         SP_TIMER_SUSPENDED_MODE       (INT16)7
#define         SP_DISK_SUSPENDED_MODE        (INT16)8
#define         SP_TERMINATED_MODE            (INT16)9

#define         SP_NUMBER_OF_STATES     SP_TERMINATED_MODE-SP_STATE_MODE_START+1
